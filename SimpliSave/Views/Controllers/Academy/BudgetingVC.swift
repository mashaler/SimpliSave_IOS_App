...
class BudgetingVC: UIViewController,YTPlayerViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Budgeting"
        ...
        if let needImage = UserDefaults.standard.string(forKey: "moneyB1") {
            if(needImage=="played"){
                ...
                let moneyB2=UserDefaults.standard.string(forKey: "moneyB2")
                let spending=UserDefaults.standard.string(forKey: "moneyB2")
                
                if(moneyB2=="played" && spending=="played"){
    ...
    @IBAction func btnMainVideo(_ sender: UIButton) {
        playVideo(link: "https://www.youtube.com/watch?v=j1Vwth0B8I8")
    ...
    @IBAction func btnNeeds(_ sender: UIButton) {
        ...
        //calling the function to play a youtube video 02/08/2023 Robert
        playVideo(link: "https://youtu.be/xjDH4zl4Ha4")
        ...
        else if(moneyB2=="played" && spending != "played"){
            img2.image = UIImage(systemName: "play.fill")
            img2.tintColor = UIColor(named: "green")
        }
        else{
    ...
    @IBAction func btnPlay2(_ sender: UIButton) {
        ...
        if(needImage=="played"){
            //play video
            playVideo(link: "https://www.youtube.com/watch?v=IXsb3aoXbVk")
    ...
    @IBAction func btnPlay3(_ sender: UIButton) {
        var moneyB2 = UserDefaults.standard.string(forKey: "moneyB2")
        if(moneyB2=="played"){
            playVideo(link: "https://www.youtube.com/watch?v=pZDxU74V924")
            UserDefaults.standard.set("played", forKey: "moneyB2")
