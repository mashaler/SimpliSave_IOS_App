...
class ServicesVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view1.clipsToBounds = false // Allow shadow to be visible beyond the bounds of the UITextView
        ...
        view2.clipsToBounds = false // Allow shadow to be visible beyond the bounds of the UITextView
